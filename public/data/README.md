...
| --- | --- | --- |
| `btc/intraday/` | Binance BTC/USDT minute spot proxy and 93 Deribit futures; optional Kraken sample days | USDT/USD=1 is assumed; no historical FX correction or executable bid/ask quotes. |
...
The currently materialized data directory is about 30 MiB, including compressed
BTC intraday candles. The browser backtest keeps

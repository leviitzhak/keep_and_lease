...
function cash(book, start, end, internal) {
  return holding({
    ...
    end_value: end, pnl_value: 0, internal_transfer_value: internal,
...
const spreadsheetRows = [
  {
    ...
    holding_ledger: [
      holding({
        ...
        start_value: 0.6, end_value: 0.66, pnl_value: 0.06,
      ...
      holding({
        ...
        start_value: 0.4, end_value: 0.404, pnl_value: 0.004,
        internal_transfer_value: 0, spot_price: 100, exit_spot_price: 110,
        maturity_days: 90,
      }),
      holding({
        ...
        start_value: 0, end_value: 0, pnl_value: 0.01,
  ...
  },
  {
    ...
    holding_ledger: [
      holding({
        ...
        start_value: 0.66, end_value: 0.726, pnl_value: 0.066,
      ...
      holding({
        ...
        start_value: 0.404, end_value: 0.40804, pnl_value: 0.00404,
        internal_transfer_value: 0, spot_price: 110, exit_spot_price: 121,
        maturity_days: 87,
      }),
      holding({
        ...
        start_value: 0, end_value: 0, pnl_value: -0.005,
      ...
      holding({
        ...
        end_value: 0.005, pnl_value: 0, internal_transfer_value: -0.005,
      ...
      holding({
        ...
        end_value: 0, pnl_value: 0, internal_transfer_value: 0,
        spot_price: 110, exit_spot_price: 121,
      }),
    ],
  },
